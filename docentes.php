...
include 'Include/delete_docente.inc.php' ;
/*
include 'Include/update.inc.php' ;  Nota: crear estos scripts
	...
	<ul class="nav menu">
		...
		<li class="parent active">
			...
			<ul class="children collapse" id="sub-item-1">
				...
				<li>
					<a class="activate" href="docentes.php">
...
include 'Template/tabla_docentes.php';
